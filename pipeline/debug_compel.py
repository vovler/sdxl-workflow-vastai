...
prompt = 'masterpiece, best quality, absurdres, cinematic lighting, ultra-detailed, 3girls, aqua_\\(konosuba\\), hands_up, arms_up, happy, joyful, ((megumin)), hands_behind_back, smug, ((lillie_\\(pokemon\\))), hands on face, ahegao, facing_the_viewer, shiny clothes'
