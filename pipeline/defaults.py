...
ONNX_MODELS_DIR = os.path.join(_project_root, "onnx_models")

# VAE
VAE_DECODER_PATH = os.path.join(ONNX_MODELS_DIR, "vae_decoder", "model.onnx")

# UNet
UNET_PATH = os.path.join(ONNX_MODELS_DIR, "unet", "model.onnx")
