...
if __name__ == "__main__":
    ...
    prompt = (
        ...
        "aqua_(konosuba), robotic_arms, left_side, facing_right, shiny skin, shiny clothes"
        "megumin, medieval_armor, blue_sword, right_side, facing_left, shiny skin, shiny clothes"
