...
def generate_image(
    ...
    negative_prompt = "worst quality, bad quality, very displeasing, displeasing, bad anatomy, artistic error, anatomical nonsense, lowres, bad hands, watermark, logo, patreon username, signature, artist name, variations, old, oldest, extra hands, multiple_penises, deformed, mutated, ugly, disfigured, missing fingers, cropped, very displeasing, bad anatomy, conjoined, bad ai-generated, multiple_girls, multiple_boys, multiple_views"
    # Define seed
    seed = 12345
    ...
    width = 1152
    height = 768
    num_steps = 10 # DMD2 is optimized for 4 steps
    guidance = 1
